...
const RobotsAnim: React.FC = () => (
  <div className="flex items-end gap-1 mb-2 mr-3 pointer-events-none drop-shadow-xl scale-90 md:scale-100 origin-bottom-right">
    ...
    {/* Astromecánico Azul/Blanco (estilo R2-D2) */}
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col items-end">
        ...
        <div className="w-72 md:w-[360px] h-[520px] bg-white rounded-[2.5rem] shadow-2xl border border-emerald-100 flex flex-col mb-4 overflow-hidden animate-in zoom-in duration-300 origin-bottom-right">
          ...
          <div className="bg-emerald-600 p-6 flex justify-between items-center text-white">
            ...
            <button 
              ...
              className="p-2 hover:bg-emerald-700/50 rounded-xl transition-colors"
          ...
          <div className="p-4 border-t border-emerald-50 bg-white">
            <div className="flex gap-2">
              ...
              <button 
                ...
                className="bg-emerald-600 text-white w-12 h-12 rounded-2xl shadow-lg flex items-center justify-center hover:bg-emerald-700 active:scale-95 disabled:opacity-50 disabled:active:scale-100 transition-all"
              >
      ...
      >
        ...
        {!isOpen && (
          <span className="absolute -top-1 -right-1 w-6 h-6 bg-red-500 border-2 border-white rounded-full flex items-center justify-center text-[11px] font-bold animate-bounce shadow-lg">1</span>
        )}
      </button>
    </div>
  );
